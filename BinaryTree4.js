...
class BST {
    ...
    getLargestFromSubtree(current) {
        ...
        if (current.right === null) {
            console.log("getLargestFromSubtree >> return current.val ->", current.val);
            return current;
        }
    ...
    getSmallestFromSubtree(current) {
        ...
        // if there is no further nodes, return tree
        if (current.left === null) {
            console.log("getSmallestFromSubtree >> return current.val ->", current.val);
            return current;
        }
...
// make val this.root and find largest of left or smallest of right
// take smallest/largest and 
